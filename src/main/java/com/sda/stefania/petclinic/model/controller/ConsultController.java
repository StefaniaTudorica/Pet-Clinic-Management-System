...
import com.sda.stefania.petclinic.service.ConsultService;
import com.sda.stefania.petclinic.service.ConsultServiceImpl;
...
public class ConsultController {
    ...
    public void viewAllByIdAndDateBetween(){
        try {
            ...
            List<Consult> consults = consultService.findAllByIdAndDateBetween(id, startDate, endDate);
            consults.stream().forEach(consult -> System.out.println("The veterinarian id is" + consultService));
        }catch (InvalidParameterException e){
            System.out.println(e.getMessage());
        }catch (ParseException e) {
